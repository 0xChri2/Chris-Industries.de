  ...
  const socialLinks = [
    {
      ...
      name: "GitHub",
      url: "https://github.com/0xChri2",
    },
    {
      icon: <SiInstagram className="w-6 h-6" />,
      name: "Instagram",
      url: "https://www.instagram.com/chrisindustries.de/?next=%2F&hl=de",
    },
    {
      icon: <SiX className="w-6 h-6" />,
      name: "X",
      url: "https://x.com/0xChri2",
    },
    {
      icon: <LinkedIn className="w-6 h-6" />,
      name: "LinkedIn",
      url: "https://www.linkedin.com/in/0xchri2/",
    },
    {
      icon: <SiYoutube className="w-6 h-6" />,
      name: "YouTube",
      url: "https://www.youtube.com/@0xChri2",
    },
    {
      icon: <SiTwitch className="w-6 h-6" />,
      name: "Twitch",
      url: "https://twitch.tv/",
    },
  ];
  ...
  const interests = [
    {
      ...
      name: "Technologie",
      description:
        "Ich bin fasziniert von den endlosen Möglichkeiten, die die Technologie und Künstliche Intelligenz bietet. Sie verändert die Welt und ich liebe es, die neuesten Entwicklungen zu verfolgen.",
    },
    {
      icon: <ChartBar className="w-8 h-8" />,
      name: "Trading",
      description:
        "Der Finanzmarkt hat mich immer gereizt. Es ist eine Mischung aus Strategie, Analyse und psychologischer Stärke, die mich immer wieder herausfordert.",
    },
    {
      icon: <Music className="w-8 h-8" />,
      name: "Musik",
      description:
        "Musik ist für mich nicht nur Unterhaltung, sondern eine Möglichkeit, mich auszudrücken und die Welt um mich herum zu interpretieren.",
    },
    {
      icon: <Plane className="w-8 h-8" />,
      name: "Reisen",
      description:
        "Reisen ermöglicht mir, verschiedene Kulturen zu erleben und neue Perspektiven zu gewinnen. Jeder Ort hat eine einzigartige Geschichte, die ich gerne entdecke.",
    },
    {
      icon: <Camera className="w-8 h-8" />,
      name: "Fotografie",
      description:
        "Das Erstellen und Bearbeiten von Bilder ist eine meiner Leidenschaften. Es ermöglicht mir, Momente festzuhalten und kreativ zu sein.",
    },
    {
      icon: <Gamepad2 className="w-8 h-8" />,
      name: "Gaming",
      description:
        "Gaming ist nicht nur ein Hobby, sondern eine Leidenschaft. Es bietet mir eine Auszeit.",
    },
  ];
  // Twitter posts
            ...
            >
              <div className="flex flex-col md:flex-row items-center gap-12">
                <div className="md:w-1/2">
                  ...
                  <p className="text-xl text-gray-300 mb-8">Christoph</p>
                  <p className="text-gray-400 mb-8">
                    Ich bin Christoph und spezialisiere mich auf Finanzanalysen,
                    bei denen ich Techniken wie die Elliott-Wellen-Theorie und
                    andere Methoden der technischen Analyse einsetze, um präzise
                    Prognosen zu treffen und Handelsstrategien zu entwickeln.
                    Gleichzeitig bin ich ein begeisterter IT-Lernender, der sich
                    mit der Welt der Informatik beschäftigt und neue
                    Technologien und Programme studiert. In meiner Freizeit bin
                    ich leidenschaftlicher Fotograf und fokussiere mich auf
                    Porträts, Autos und Landschaften. Auf meiner Webseite teile
                    ich meine vielseitigen Interessen, die sowohl meine
                    analytische als auch kreative Seite widerspiegeln. Lass dich
                    inspirieren!
                  </p>
                  <button
            ...
            >
              ...
              <div className="mb-12 bg-gradient-to-r from-blue-600/20 to-blue-400/20 backdrop-blur-sm rounded-xl p-8 border border-blue-500/30 shadow-lg shadow-blue-500/5">
                <div className="flex items-center gap-4 mb-6">
                  <SiX className="w-8 h-8 text-blue-400" />
          ...
          >
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-8 border border-gray-700">
              ...
              <p className="text-gray-400 mb-4">
                ...
                Chris Industries geltenden landesspezifischen
              ...
              <p className="text-gray-400 mb-4">
                ...
                <br />
                Die Internetseite von Chris Industries erfasst mit jedem Aufruf
              ...
              <p className="text-gray-400 mb-4">
                Diese Informationen werden benötigt, um (1) die Inhalte unserer
                ...
                Internetseite zu gewährleisten sowie (4)
                ...
                anonym erhobenen Daten und Informationen werden durch Chris
                Industries daher einerseits statistisch und ferner mit dem Ziel
        ...
        <footer className="md:ml-64 bg-gray-900/80 backdrop-blur-md border-t border-gray-800 py-8">
          <div className="container mx-auto px-6">
            ...
            <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-500 text-sm">
              ...
              <div className="mt-4">
                © {new Date().getFullYear()} Chris Industries. Alle Rechte
                vorbehalten.
              </div>
            </div>
          </div>
